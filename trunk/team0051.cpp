...
class team0051  //here the class name is given to be team0002 assuming that the registration no. of the participant was 2 
{
...
/*static int move=1;	                             //is at empty slot
	 if(move==1)
...
else if((((p[ball_player].strength/2-dist)>0)&&((p[i].x-p[ball_player].x)<large)&&(pl==12)))
{
